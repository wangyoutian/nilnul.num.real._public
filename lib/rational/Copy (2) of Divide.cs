...
using nilnul.math.number.integer.expr;
...
namespace nilnul.math.number.rational.func
{
	public partial class Divide
	{
		...
		{
			RationalI v=return new Rational(a.numerator.bigInt*b.denominator.bigInt,a.denominator.bigInt*b.numerator.bigInt);
				
				eval(a.numerator.Multiply(b.denominator), a.denominator.Multiply(b.numerator));
